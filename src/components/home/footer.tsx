    ...
    <footer className="bg-gray-100">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/payment" className="text-sm text-gray-600 hover:text-primary">
                  Payment Options
                </Link>
              </li>
              <li>
                <Link href="/gift-cards" className="text-sm text-gray-600 hover:text-primary">
                  Gift Cards
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 text-center">
          <p className="text-sm text-gray-600">&copy; 2025 SecondHand. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
